...
class WashingProgram1 extends WashingProgram {
	 ...
	 */
	public WashingProgram1(AbstractWashingMachine mach, double speed, TemperatureController tempController, WaterController waterController, SpinController spinController) {
	...
	protected void wash() throws InterruptedException {
        ...
        myTempController.putEvent(new TemperatureEvent(this, TemperatureEvent.TEMP_SET, 60d));
        mailbox.doFetch();

        mySpinController.putEvent(new SpinEvent(this, SpinEvent.SPIN_SLOW));
        long sleepTime = System.currentTimeMillis () + (long) (30d * 60d * 1000d / mySpeed);
